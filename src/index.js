...
if (hasUserMedia) {
    navigator.mediaDevices.enumerateDevices()
             .then(function (sources) {
                 ...
                 console.log(JSON.stringify(mediaOption));
...
//     canvas.style.width = (5*video.offsetWidth)+'px'
//     canvas.style.height = (5*video.offsetHeight)+ 'px'
// })
...
function createReUi (data){
     ...
     $('#success_layer .res-real').html(realResUi)
     $('#success_layer .res-list').html(userResUi)
